...
<?php include_once "encabezado.php" ?>
	<div class="col-xs-12">
		...
		<form method="post" action="guardarDatosEditados.php">
			...
			<textarea required id="autor" name="autor" cols="30" rows="1" class="form-control"><?php echo $producto->autor ?></textarea>

			<label for="editorial">Editorial:</label>
			<textarea required id="editorial" name="editorial" cols="30" rows="1" class="form-control"><?php echo $producto->editorial ?></textarea>
